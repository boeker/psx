...
void CPU::RTPT() {
    ...
    int16_t in_vx1 = gte.getRegister(GTE_REG_VXY1) & 0xFFFF;
    int16_t in_vy1 = gte.getRegister(GTE_REG_VXY1) >> 16;
    int16_t in_vz1 = gte.getRegister(GTE_REG_VZ1) & 0xFFFF;

    int16_t in_vx2 = gte.getRegister(GTE_REG_VXY2) & 0xFFFF;
    int16_t in_vy2 = gte.getRegister(GTE_REG_VXY2) >> 16;
    int16_t in_vz2 = gte.getRegister(GTE_REG_VZ2) & 0xFFFF;
    ...
    gte.setRegister(GTE_REG_SXY0, (((uint32_t)temp_sx0) << 16) | ((uint32_t)temp_sy0));
    gte.setRegister(GTE_REG_SXY1, (((uint32_t)temp_sx1) << 16) | ((uint32_t)temp_sy1));
    gte.setRegister(GTE_REG_SXY2, (((uint32_t)temp_sx2) << 16) | ((uint32_t)temp_sy2));
    gte.setRegister(GTE_REG_SXYP, (((uint32_t)temp_sx2) << 16) | ((uint32_t)temp_sy2));
    gte.setRegister(GTE_REG_SZ0, gte.getRegister(GTE_REG_SZ1));
    gte.setRegister(GTE_REG_SZ1, temp_sz1);
    gte.setRegister(GTE_REG_SZ2, temp_sz2);
    gte.setRegister(GTE_REG_SZ3, temp_sz3);
}
