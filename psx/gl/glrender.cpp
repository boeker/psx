...
GLRender::GLRender() {
    ...
    if (!success) {
        ...
        Log::log(std::format("Vertex shader compilation failed: {:s}", infoLog));
    }
    ...
    if (!success) {
        ...
        Log::log(std::format("Fragment shader compilation failed: {:s}", infoLog));
    }
    ...
    if (!success) {
        ...
        Log::log(std::format("Program linking failed: {:s}", infoLog));
    }
