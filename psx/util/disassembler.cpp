...
const char* Disassembler::GTE_REGISTER_NAMES[] = {
...
const Disassembler::Opcode Disassembler::cp2Move[] = {
    // 0b00000
    &Disassembler::MFC2,     &Disassembler::UNKCP2M,  &Disassembler::CFC2,     &Disassembler::UNKCP2M,
    // 0b00100
